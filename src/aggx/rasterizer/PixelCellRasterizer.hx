...
class PixelCellRasterizer {
	...
	//---------------------------------------------------------------------------------------------------
	private inline function get_cellsCount():UInt {
		return _cellsCount;
	}
	...
	//---------------------------------------------------------------------------------------------------
	private inline function get_isSorted():Bool {
		return _isSorted;
	}
	...
	//---------------------------------------------------------------------------------------------------
	private function qsort(data:Data, beg:UInt, end:UInt):Void {
		if (end == beg) {
			return;
		}
	...
	//---------------------------------------------------------------------------------------------------
	private function getPivotPoint(data:Data, beg:UInt, end:UInt):Pointer {
