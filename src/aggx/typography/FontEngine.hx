...
class FontEngine {
	...
	public function renderStringStroke(string:String, fontSize:Float, dx:Float, dy:Float, renderer:IRenderer, width:Float, kern:Float = 0.0,
			vector:Vector2 = null):Void {
		// intentionally left here for debugging
	...
	private function renderStringInternal(path:IVertexSource, string:String, fontSize:Float, dx:Float, dy:Float, renderer:IRenderer, kern:Float = 0.0,
			vector:Vector2 = null):Void {
		if (rasterizer == null) {
	...
	//---------------------------------------------------------------------------------------------------
	private inline function get_path():VectorPath {
		return _path;
	}
